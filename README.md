...
\
Note: The database needs to be have been created and the `DATABASE_URL` environment variable is set in your [.env](https://github.com/mentorpaired/yakitabu-backend/blob/staging/.env.example) file.
  ```sh
